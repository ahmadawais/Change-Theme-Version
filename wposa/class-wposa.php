<?php
/**
 * Main Class file for `WP_OSA_CTV`
 *
...
class WP_OSA_CTV {
	...
	public function admin_menu() {
	    ...
	    add_options_page( 'Change Version', 'Change Version', 'manage_options', 'ctv_settings', array( $this, 'plugin_page' ) );

	}

	public function plugin_page() {
	    echo '<div class="wrap">';
	    	echo '<h1>Change Theme Version <span style="font-size:50%;">v' . CTV_VERSION . '</span></h1>';
	    	echo '<p>Changes the version of active theme.</p>';
